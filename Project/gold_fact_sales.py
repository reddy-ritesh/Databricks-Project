...
df_silver = spark.sql("SELECT * FROM PARQUET. `abfss://silver@cardatalakeritesh.dfs.core.windows.net/carsales`")
...
if spark.catalog.tableExists('factsales'):
    ...
    .mode('overwrite')\
    .option('path', "abfss://gold@cardatalakeritesh.dfs.core.windows.net/factsales" )\
